...
public class Lesson8 extends AppCompatActivity
    ...
    public void onClick(View v) {
        if (buttonGet == v) {
            speechGet();
        } else if (buttonGreen == v) {
            speechGreen();
        } else if (buttonKey == v) {
            speechKey();
        } else if (Next == v) {
            Intent it = new Intent(this, Lesson9.class);
            startActivity(it);
        }
    }
    ...
    private void speechGet() {
        String string = ((Button) findViewById(R.id.ButtonGet)).getText().toString();
    ...
    private void speechGreen() {
        String string = ((Button) findViewById(R.id.Buttongreen)).getText().toString();
    ...
    private void speechKey() {
        String string = ((Button) findViewById(R.id.ButtonKey)).getText().toString();
