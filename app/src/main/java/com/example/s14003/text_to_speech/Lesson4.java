...
public class Lesson4 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBoy.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (buttonBoy == v) {
            ...
            Intent it = new Intent(this, Lesson5.class);
            startActivity(it);
        }
    }
    ...
    private void speechBoy() {
        String string = ((Button)findViewById(R.id.ButtonBoy)).getText().toString();
