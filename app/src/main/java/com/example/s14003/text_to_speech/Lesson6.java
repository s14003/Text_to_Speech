...
public class Lesson6 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonShine = (Button)findViewById(R.id.ButtonShine);
        buttonShine.setOnClickListener(this);
    ...
    public void onClick(View v) {
        if (buttonShine == v) {
            ...
            Intent it = new Intent(this, Lesson7.class);
            startActivity(it);
        }
    }
    ...
    private void speechShine() {
        String string = ((Button)findViewById(R.id.ButtonShine)).getText().toString();
    ...
    private void speechRad() {
        String string = ((Button)findViewById(R.id.ButtonRad)).getText().toString();
    ...
    private void speechRed() {
        String string = ((Button)findViewById(R.id.ButtonRed)).getText().toString();
